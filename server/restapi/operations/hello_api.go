...
func NewHelloAPI(spec *loads.Document) *HelloAPI {
	return &HelloAPI{
		...
		PostHelloHandler: PostHelloHandlerFunc(func(params PostHelloParams) middleware.Responder {
			return middleware.NotImplemented("operation PostHello has not yet been implemented")
		}),
	}
}
...
type HelloAPI struct {
	...
	// PostHelloHandler sets the operation handler for the post hello operation
	PostHelloHandler PostHelloHandler
...
func (o *HelloAPI) Validate() error {
	...
	if o.PostHelloHandler == nil {
		unregistered = append(unregistered, "PostHelloHandler")
	}
...
func (o *HelloAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/hello"] = NewPostHello(o.context, o.PostHelloHandler)
}
